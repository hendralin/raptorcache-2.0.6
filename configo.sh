...
wget https://raw.githubusercontent.com/hendralin/raptorcache-2.0.6/main/raptor_d8.sql --no-check-certificate
...
if [ ! -f my.tar.gz ]; then
wget https://github.com/hendralin/raptorcache-2.0.6/raw/main/my.tar.gz --no-check-certificate
fi
mv my.tar.gz /tmp
